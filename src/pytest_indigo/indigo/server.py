...
from pytest_indigo.indigo.enums import kLicenseStatus
from pytest_indigo.indigo.plugin import PluginInfo
...
class ServerInfo:
    ...
    def getLatitudeAndLongitude(self) -> Tuple[float, float]:  # noqa: UP006
